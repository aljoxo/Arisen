...
Total size of modlist (with downloads): 
...
4. Set the installation folder to be somewhere like C:\Games\Arisen. **DO NOT place it in Program Files, User folders (such as Desktop, Documents, Downloads, etc.), or in your Skyrim's Steam folder**
...
- [Cosmofujia Elden Ring Greatsword and Zweihander](https://www.patreon.com/file?h=72737515&i=11928348)
- [Cosmofujia Rivers of Blood and Moonveil](https://www.patreon.com/file?h=68558668&i=11129077)
- [Cosmofujia Hand of Malenia](https://www.patreon.com/file?h=72630858&i=12246897)
...
#### Obligatory DAR Cache warning: due to the extensive amount of animations used in the list, when loading up a save for the first time every play session, you may notice your character T-Posing when trying to execute certain actions (like sprinting). This is due to DAR having to take the time to cache all of the animation folders since it does not precache them through Nemesis or during load screens. The time it takes for DAR to cache is affected by how many actors are being rendered and your PC, it should usually take no longer than 30 seconds.
...
### In-Game MCM options
 ...
 - **Valhalla Combat**: The core of the combat balance in the list. 
    - Stamina: The Stamina system in this list is managed by Fenix's mod. Please do not edit any settings here, otherwise you will likely have a messed up combat system.
...
Wabbajack [downgrades](https://www.nexusmods.com/skyrimspecialedition/mods/57618) your install for you to version (1.5.97) of Skyrim. Please **do not** downgrade your steam install or the modlist yourself, but as stated at the top of this document, it **does require** the paid update.
