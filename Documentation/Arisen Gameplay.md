...
Now that we've discussed the perks and general progression itself, let's talk about how you will actually improve your character within the list. Gone are the days of getting perks by leveling up. As of version 1.4, Arisen has changed to a system in which perks are rewarded by completing content and exploring.
